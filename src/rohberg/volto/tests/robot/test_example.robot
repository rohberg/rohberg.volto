...
#
#  $ bin/test -s rohberg.volto -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src rohberg.volto.testing.ROHBERG_VOLTO_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/rohberg/volto/tests/robot/test_example.robot
#
